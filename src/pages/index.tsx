		...
		<div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
				<div className="text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto">
					...
					<motion.p
						...
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni sequi, nam pariatur
						ipsa iste, ipsam ducimus accusantium mollitia perferendis molestiae enim. Quae aspernatur 
						soluta tempora voluptate modi cum, molestiae omnis!
					</motion.p>
